...
{  public :
	GsVec coords;
	float coordsw;
	static const GsPlane XY, //<! The plane of ( GsVec::null, GsVec::i, GsVec::j )
						 XZ, //<! The plane of ( GsVec::null, GsVec::i, GsVec::k )
						 YZ; //<! The plane of ( GsVec::null, GsVec::j, GsVec::k )
   public:
	...
	/*! Returns p, that is the intersection between GsPlane and the infinity
