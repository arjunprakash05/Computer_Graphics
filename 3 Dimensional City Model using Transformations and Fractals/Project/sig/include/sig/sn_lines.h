...
{  public :
   ...
   ~SnLines ();
	...
	void push_box ( const GsBox& box, bool multicolor=false );
	...
	/*! Push an array of points assuming each 2 consecutive points denote one line */
	void push_lines ( const GsArray<GsVec2>& a, float z=0 );
