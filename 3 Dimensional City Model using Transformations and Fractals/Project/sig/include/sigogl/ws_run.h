...
/*! Check function designed for local interactions such as waiting for a dialog box.
...
/*! OpenGl functions will be automatically loaded when the first window is open.
	This function can be used to load OpenGL functions before that. */
void ws_load_ogl ();

/*! Returns the number of OpenGl functions which have been loaded, 0 if none loaded yet. */
inline unsigned ws_ogl_loaded () { extern unsigned wsi_ogl_loaded (); return wsi_ogl_loaded(); }
