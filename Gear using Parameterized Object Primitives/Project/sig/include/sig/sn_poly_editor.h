...
{  public :
   ...
   private :
	...
	GsVec2 _min, _max;
	gscenum _mode;
	gscbool _add_vertices, _edjuststarted, _genevnotused;
   ...
   public :
	...
	void polygons_changed () { _polygons->touch(); }
	...
	/*! Set a user callback that is called each time an event is processed. The 3rd parameter
		is the selected polygon. */
	void callback ( void(*cb)(SnPolyEditor*,Event,int), void* udata )
	  { _user_cb=cb; _userdata=udata; }
