...
// variables ( as GsVec::i, ... ), as we cannot know the order that they
// will be initialized by the compiler.

const GsLine GsLine::x ( GsVec::null, GsVec::i );
const GsLine GsLine::y ( GsVec::null, GsVec::j );
const GsLine GsLine::z ( GsVec::null, GsVec::k );
