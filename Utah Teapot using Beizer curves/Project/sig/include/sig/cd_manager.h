...
/* CdManager serves as a class that can be connected to different collision
   detection algorithms, by vonnecting it to a CdImplementation class */
class CdManager
 { private:
	CdImplementation* _cdi;
	static CdImplementation* _defcdi;

   public:
	/*! Set the default implementation to be used by CdManager */
	static void set_default_implementation ( CdImplementation* cdi );
   ...
   ~CdManager ();
	...
	/*! Set new implementation to be used */
