...
class UiStyle
{ public :
	/*! Current contains the current style being used by elements when they are created. Initialized as style Light. */
	static UiStyle Current;

	/*! Dialog contains the style that will become current when dialog boxes are created. Initialized as style Gray. */
