...
// Static members:
UiStyle UiStyle::Current ( UiStyle::Light );
UiStyle UiStyle::Dialog ( UiStyle::Gray );
...
void UiStyle::set_light_style ()
 {
	color.background = GsColor::white;
	...
	color.close_button = GsColor::red;
...
void UiStyle::set_dark_style ()
{
	...
	color.background = GsColor::black;//bg;
